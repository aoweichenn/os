...
OS_USER_ELF_MINIMUM_VIRTUAL_ADDRESS = 0x0000_0000_0001_0000
OS_USER_ELF_MAXIMUM_VIRTUAL_ADDRESS_EXCLUSIVE = 0x0000_8000_0000_0000
...
def parseUserLoadSegments(
    ...
    for programHeaderIndex in range(programHeaderCount):
        ...
        if (
            ...
            raise OsToolError("用户 ELF 加载段超出用户地址边界。")
