...
OS_ROOTFS_V2_MAGIC = b"OSRFV003"
OS_ROOTFS_V2_VERSION = 3
...
OS_ROOTFS_V2_JOURNAL_START_RELATIVE_BLOCK = 4227
OS_ROOTFS_V2_JOURNAL_BLOCK_COUNT = 256
...
def validateRootfsV2StaticLayout() -> None:
    ...
    if (
        ...
        raise OsToolError("rootfs v2 数据位图与 journal 不连续。")
    if (
        OS_ROOTFS_V2_JOURNAL_START_RELATIVE_BLOCK
        + OS_ROOTFS_V2_JOURNAL_BLOCK_COUNT
        != OS_ROOTFS_V2_DATA_START_RELATIVE_BLOCK
    ):
        raise OsToolError("rootfs v2 journal 与数据区不连续。")
    if (
        OS_ROOTFS_V2_DATA_START_RELATIVE_BLOCK
        + OS_ROOTFS_V2_DATA_BLOCK_COUNT
        != OS_ROOTFS_V2_TOTAL_BLOCK_COUNT
