...
def handleQemuFirmware(arguments: argparse.Namespace) -> None:
    ...
    if arguments.expectedOutcome == "success":
        ...
        expectedMarkerCounts = (
            ...
            (OS_QEMU_USER_EXEC_COMMITTED_MARKER, 1),
        ...
        minimumHexMarkerValues = (
            ...
            (OS_QEMU_KERNEL_PROCESS_KERNEL_STACK_TOP_MARKER, 1),
            (OS_QEMU_KERNEL_PROCESS_KERNEL_STACK_UPPER_GUARD_MARKER, 1),
            (OS_QEMU_KERNEL_SCHEDULER_CREATED_PROCESSES_MARKER, 11),
            (OS_QEMU_KERNEL_SCHEDULER_TERMINATED_PROCESSES_MARKER, 11),
            (OS_QEMU_KERNEL_SCHEDULER_TIMER_TICKS_MARKER, 1),
            (OS_QEMU_KERNEL_SCHEDULER_PREEMPTIONS_MARKER, 1),
            ...
            (OS_QEMU_KERNEL_PROCESS_TREE_REGISTERED_MARKER, 11),
            (OS_QEMU_KERNEL_PROCESS_TREE_EXITED_MARKER, 11),
            (OS_QEMU_KERNEL_PROCESS_TREE_COLLECTED_MARKER, 11),
            (OS_QEMU_KERNEL_PROCESS_TREE_REPARENTED_MARKER, 1),
            (OS_QEMU_KERNEL_PROCESS_TREE_WAIT_SUCCESSES_MARKER, 10),
            (OS_QEMU_KERNEL_PROCESS_TREE_WAIT_BLOCKS_MARKER, 1),
            (OS_QEMU_KERNEL_PROCESS_TREE_WAIT_NO_CHILD_MARKER, 1),
        )
        if (
