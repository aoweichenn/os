...
def handleQemuFirmware(arguments: argparse.Namespace) -> None:
    ...
    if functionalShellAcceptance:
        ...
        functionalShellMarkerCounts = (
            ...
            (OS_QEMU_USER_SHELL_HISTORY_OUTPUT_MARKER, 4),
    ...
    if arguments.expectedOutcome in ("success", "reclaim-pressure"):
        requiredMarkers = (
            OS_QEMU_FIRMWARE_RESET_MARKER,
            OS_QEMU_FIRMWARE_VGA_READY_MARKER,
            OS_QEMU_FIRMWARE_CLOCK_READY_MARKER,
    ...
    runQemuFirmwareBoot(
        ...
        keyboardInputText=(
            shellTestInput
            if arguments.expectedOutcome in ("success", "reclaim-pressure", "nvme-storage")
            else None
        ),
        keyboardReadyMarker=(
            OS_QEMU_KERNEL_IO_FIRST_DESCRIPTOR_READ_BLOCK_MARKER
