...
from os_tools.qemu_runner import (
    ...
    OS_QEMU_KERNEL_THREAD_PEAK_ACTIVE_TWO_MARKER,
    OS_QEMU_KERNEL_THREAD_CREATIONS_FOUR_MARKER,
    ...
    OS_QEMU_KERNEL_THREAD_EXITS_FOUR_MARKER,
    OS_QEMU_KERNEL_THREAD_REAPS_FOUR_MARKER,
