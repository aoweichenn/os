...
def handleQemuFirmware(arguments: argparse.Namespace) -> None:
    ...
    if arguments.expectedOutcome == "success":
        ...
        expectedMarkerCounts = (
            ...
            (OS_QEMU_USER_WORKER_PROCESS_2_STEP_1_MARKER, 1),
            (OS_QEMU_USER_WORKER_PROCESS_2_STEP_2_MARKER, 1),
            (OS_QEMU_USER_WORKER_PROCESS_2_STEP_3_MARKER, 1),
            ...
            (OS_QEMU_USER_ADDRESS_SPACE_ISOLATED_MARKER, 3),
            ...
            (OS_QEMU_KERNEL_USER_SMOKE_SYSTEM_CALL_COUNT_MARKER, 4),
