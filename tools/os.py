...
OS_TOOL_QEMU_FUNCTIONAL_SHELL_ACCEPTANCE_PROCESS_COUNT = 58
...
OS_TOOL_QEMU_FUNCTIONAL_ADDITIONAL_ECHO_MARKER_COUNT = 9
OS_TOOL_QEMU_FUNCTIONAL_ADDITIONAL_CAT_MARKER_COUNT = 7
OS_TOOL_QEMU_FUNCTIONAL_ADDITIONAL_REMOVE_MARKER_COUNT = 5
...
def handleQemuFirmware(arguments: argparse.Namespace) -> None:
    ...
    if functionalShellAcceptance:
        ...
        functionalShellMarkerCounts = (
            (OS_QEMU_USER_SHELL_REDIRECTION_VERIFIED_MARKER, 6),
            ...
            (OS_QEMU_USER_SHELL_SEQUENCE_SECOND_OUTPUT_MARKER, 2),
