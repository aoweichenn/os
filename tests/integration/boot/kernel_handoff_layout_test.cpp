...
constexpr std::string_view OS_TEST_HANDOFF_LAYOUT_BOOT_INFO_SCRATCH =
    "BootInfo 不得覆盖加载器工作区";
constexpr std::string_view OS_TEST_HANDOFF_LAYOUT_SCRATCH_STAGING =
    "加载器工作区不得覆盖 ELF 暂存区";
...
constexpr os::foundation::AddressValue OS_TEST_HANDOFF_LAYOUT_BOOT_INFO_SIZE =
    os::foundation::AddressValue{0x00000050};
...
int main() {
    ...
    testContext.expect(!scratchRange.overlaps(stagingRange),
                       OS_TEST_HANDOFF_LAYOUT_SCRATCH_STAGING);
