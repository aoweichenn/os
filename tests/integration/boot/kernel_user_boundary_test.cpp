...
int main() {
    os::test::TestContext testContext{OS_TEST_USER_BOUNDARY_SUITE_NAME};
    os::kernel::ExceptionFrame kernelFrame{};
    kernelFrame.codeSegment = OS_TEST_USER_BOUNDARY_KERNEL_CODE_SELECTOR;
    os::kernel::UserPrivilegeFrame userFrame{};
    userFrame.common.codeSegment = OS_TEST_USER_BOUNDARY_USER_CODE_SELECTOR;
    testContext.Expect(!os::kernel::FrameOriginatedFromUser(kernelFrame) &&
                           os::kernel::FrameOriginatedFromUser(userFrame.common) &&
                           &os::kernel::AsUserPrivilegeFrame(userFrame.common) == &userFrame,
                       OS_TEST_USER_BOUNDARY_FRAME_MESSAGE);

    testContext.Expect(os::kernel::OS_KERNEL_USER_STACK_PAGE_COUNT ==
