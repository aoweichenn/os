...
class QemuRunnerToolTests(unittest.TestCase):
    ...
    def testMapsShellCharactersToQemuKeys(self) -> None:
        ...
        self.assertEqual(qemuKeyNameForCharacter("A"), "shift-a")
        self.assertEqual(qemuKeyNameForCharacter("_"), "shift-minus")
        self.assertEqual(qemuKeyNameForCharacter("$"), "shift-4")
        self.assertEqual(qemuKeyNameForCharacter("*"), "shift-8")
        self.assertEqual(qemuKeyNameForCharacter("?"), "shift-slash")
        self.assertEqual(qemuKeyNameForCharacter("\\"), "backslash")
        self.assertEqual(qemuKeyNameForCharacter("\x02"), "left")
        self.assertEqual(qemuKeyNameForCharacter("\x06"), "right")
        self.assertEqual(qemuKeyNameForCharacter("\x10"), "up")
        self.assertEqual(qemuKeyNameForCharacter("\x0e"), "down")
        self.assertEqual(qemuKeyNameForCharacter("\t"), "tab")
