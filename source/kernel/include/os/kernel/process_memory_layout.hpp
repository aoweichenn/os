...
inline constexpr uint64_t OS_KERNEL_PROCESS_KERNEL_STACK_GUARD_SIZE_BYTES =
    OS_KERNEL_PROCESS_KERNEL_STACK_GUARD_PAGE_COUNT * OS_KERNEL_MEMORY_PAGE_SIZE_BYTES;
...
inline constexpr uint64_t OS_KERNEL_PROCESS_KERNEL_STACK_STORAGE_SIZE_BYTES =
    OS_KERNEL_PROCESS_KERNEL_STACK_GUARD_SIZE_BYTES + OS_KERNEL_PROCESS_KERNEL_STACK_SIZE_BYTES;

[[nodiscard]] uint64_t ProcessKernelStackGuardPageAddress(uint64_t process_index) noexcept;
[[nodiscard]] uint64_t ProcessKernelStackTopAddress(uint64_t process_index) noexcept;
[[nodiscard]] bool ProcessKernelStackContains(uint64_t process_index, uint64_t address,
