...
inline constexpr uint64_t OS_KERNEL_ROOTFS_JOURNAL_START_RELATIVE_BLOCK = 4227ULL;
inline constexpr uint64_t OS_KERNEL_ROOTFS_JOURNAL_BLOCK_COUNT = 256ULL;
...
inline constexpr uint64_t OS_KERNEL_ROOTFS_FORMAT_VERSION = 3ULL;
...
inline constexpr uint64_t OS_KERNEL_ROOTFS_REQUIRED_FEATURES =
    ...
    OS_KERNEL_ROOTFS_FEATURE_ORDERED_METADATA_JOURNAL;
