...
inline constexpr uint64_t OS_KERNEL_ROOTFS_V5_INODE_FLAG_ORPHAN = 1ULL << 0ULL;
inline constexpr uint64_t OS_KERNEL_ROOTFS_V5_SUPPORTED_INODE_FLAGS =
    OS_KERNEL_ROOTFS_V5_INODE_FLAG_ORPHAN;
