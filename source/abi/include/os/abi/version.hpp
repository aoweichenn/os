...
inline constexpr uint64_t OS_ABI_VERSION_MINOR = 0ULL;
inline constexpr uint64_t OS_ABI_VERSION_PATCH = 0ULL;
inline constexpr uint64_t OS_ABI_SYSTEM_CALL_COUNT = 69ULL;
inline constexpr uint64_t OS_ABI_SYSTEM_CALL_LAST_NUMBER = 69ULL;
