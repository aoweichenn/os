...
inline constexpr uint64_t OS_ABI_MEMORY_SYNC_ASYNCHRONOUS = 1ULL << 0ULL;
inline constexpr uint64_t OS_ABI_MEMORY_SYNC_INVALIDATE = 1ULL << 1ULL;
inline constexpr uint64_t OS_ABI_MEMORY_SYNC_SYNCHRONOUS = 1ULL << 2ULL;
inline constexpr uint64_t OS_ABI_MEMORY_SYNC_VALID_FLAG_MASK =
    OS_ABI_MEMORY_SYNC_ASYNCHRONOUS | OS_ABI_MEMORY_SYNC_INVALIDATE |
    OS_ABI_MEMORY_SYNC_SYNCHRONOUS;
