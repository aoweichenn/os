...
当前 v2.0 PDF 为 429 页、5113710 字节，SHA-256 为
`422ab3a8dd30ae8960b3e64d56414e6687e8d15d238186026cd672d7493e3e54`；手机
书库和网站下载件必须逐字节同哈希。
...
当前书稿为 5 部 10 个完整主题章。当前生产目标包含 208 个核心
...
v2.0 不再加入 Kernel 机制，而是在第十章把项目/ABI/盘面版本分离、三档机器、
