...
\code{0x00100000..0x03600000} & \code{PT\_LOAD} 窗口 & 与高地址源暂存区严格分离\\
\code{0x03600000..0x03E00000} & Kernel 文件暂存 & 经 E820 验证的 8 MiB 上限\\
...
\code{0x18} & Kernel 文件地址 & \code{0x03600000}\\
