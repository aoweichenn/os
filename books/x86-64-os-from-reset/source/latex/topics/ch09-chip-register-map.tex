...
当前 GDT limit=39，IDT limit=4095，TR=\code{0x18}。
...
\midrule
\endhead
GDTR & 80 位 & LGDT/SGDT & 五槽 GDT 的 base/limit\\
...
data/instruction fetch。当前注入结果为全零，CR2 为
\code{0x04000000}：Ring 0 读取 not-present 数据页。

机器可读 YAML 同时列出 32 个 present 异常门、十个硬件错误码向量，以及
