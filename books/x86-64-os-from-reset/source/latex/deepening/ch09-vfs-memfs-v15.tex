...
v1.6 将在 VFS 不变的前提下引入版本化 rootfs v2、完整 create/mkdir/
unlink/rename/truncate/stat、稀疏大文件、独立 mkfs/inspector/fsck 和
崩溃边界。若 v1.6 需要改变本章的 Path、Mount 或 FileDescription 基本语义，
应先解释为什么 v1.5 双后端与十万步模型不足，而不能悄悄绕开接口。
