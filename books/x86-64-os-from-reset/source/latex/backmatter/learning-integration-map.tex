...
前言与阅读地图；第 5 章机器边界；第 20 章指标、实践与验收 \\ \hline
...
第 9 章完整工具链；第 11 章 ELF loader；第 20 章可复现证据 \\ \hline
...
第 12 章内存/异常主线；第 13 章用户边界；第 16 章虚拟内存；术语表 \\ \hline
...
第 5 章工程闭环；第 9 章工具链；第 10/20 章证据与实践 \\ \hline
\learningpathii{02-v0.1-reset-}{and-serial.md} &
复位状态、段/栈、COM1、PIT、ROM 布局、串口协议、故障注入 &
第 6 章复位；第 9 章 ROM；第 10 章 UART；第 11 章启动全图 \\ \hline
...
第 6 章历史依赖；第 11 章模式转换及失败定位 \\ \hline
...
第 4、7、11、13、17--19 章共七张横置整页矢量图及逐图讲解 \\ \hline
