...
前言与阅读地图；第 1 章机器边界；第 16 章指标、实践与验收 \\
...
第 5 章完整工具链；第 7 章 ELF loader；第 16 章可复现证据 \\
...
第 8 章内存/异常主线；第 9 章用户边界；第 12 章虚拟内存；术语表 \\
...
第 1、3、7、9、13--15 章共七张横置整页矢量图及逐图讲解 \\
