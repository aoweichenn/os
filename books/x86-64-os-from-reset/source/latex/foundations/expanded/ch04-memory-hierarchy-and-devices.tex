...
\begin{circuitikz}
  ...
  \begin{scope}[xshift=6cm]
    ...
    \draw[os bus] (mc.north) -- ++(0,0.55) -| (dimm.north);
    \node[BookMuted,align=center,anchor=south] at (1.8,3.18)
      {命令、地址与数据};
    \draw[os arrow] (dimm.south) -- ++(0,-0.55) -| (mc.south);
    \node[BookMuted,align=center,anchor=north] at (1.8,0.72)
      {训练结果与状态};
