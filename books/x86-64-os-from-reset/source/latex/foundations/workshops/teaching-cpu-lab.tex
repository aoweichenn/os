...
可以选择总线错误、超时或机器检查，具体机制不同；共同要求是软件能区分
“目标返回了数值 0”和“目标根本没有响应”。
...
源文件实现逐周期状态变化，\filepath{source/main.cpp} 放入四组程序。以下
...
ready 延迟、非法操作码和总线无响应四种结果。构建发生在临时目录，不会把
宿主二进制混进书稿。
