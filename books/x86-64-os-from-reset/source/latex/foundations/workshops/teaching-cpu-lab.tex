...
随书配套源码中的
\filepath{examples/teaching_cpu} 是一个可以独立运行的示例。公共头文件定义
ISA 状态与总线边界，源文件实现逐周期状态变化，
\filepath{examples/teaching_cpu/source/main.cpp} 组合五个运行场景。以下
